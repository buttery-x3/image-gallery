...
| `defaultAppearance` | Compact, portrait, Classic | Defaults for tile width, ratio, fit, zoom, actions, visual theme, and sticky header |
...
| `contentNotice` | built-in notice | Notice title and HTML, agreement-button label, persistent header-button label, expansion label, and expanded HTML |
